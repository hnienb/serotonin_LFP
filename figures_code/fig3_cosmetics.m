...
text(-0.065, 0.5, [num2str(nspk) ' spikes'], 'fontsize', 6)
% offset axis
...
for a = 1:2 % animals
    for d = 1:2 % drugs
        ...
        text(0.025, yrange(a,1)+0.95*(yrange(a,2)-yrange(a,1)), ['n = ' num2str(nses(a, d))], 'fontsize', 6)
        text(0.025, yrange(a,1)+0.85*(yrange(a,2)-yrange(a,1)), 'baseline', 'color', 'k', 'fontsize', 6)
        text(0.025, yrange(a,1)+0.75*(yrange(a,2)-yrange(a,1)), drugs{d}, 'color', 'r', 'fontsize', 6)
        if d==1
    ...
    text(0.025, yrange(a,1)+0.95*(yrange(a,2)-yrange(a,1)), ['n = ' num2str(sum(nses(a, :)))], 'fontsize', 6)
    text(0.025, yrange(a,1)+0.85*(yrange(a,2)-yrange(a,1)), 'high FR', 'color', 'k', 'fontsize', 6)
    text(0.025, yrange(a,1)+0.75*(yrange(a,2)-yrange(a,1)), 'low FR', 'color', 'r', 'fontsize', 6)
